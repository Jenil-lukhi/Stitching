    ...
    public class BarbieFrock_Activity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_barbie_frock);
            ...
            sharedPreferences = getSharedPreferences("liked_Images2", MODE_PRIVATE);

            isLiked1 = sharedPreferences.getBoolean("isLiked9", false);
            isLiked2 = sharedPreferences.getBoolean("isLiked10", false);
            isLiked3 = sharedPreferences.getBoolean("isLiked11", false);
            isLiked4 = sharedPreferences.getBoolean("isLiked12", false);
            isLiked5 = sharedPreferences.getBoolean("isLiked13", false);
            isLiked6 = sharedPreferences.getBoolean("isLiked14", false);
            isLiked7 = sharedPreferences.getBoolean("isLiked15", false);
            isLiked8 = sharedPreferences.getBoolean("isLiked16", false);
            ...
            im1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/hqQWd_cGrfk?si=yRpVm_clfn-UiVoW");
                }
            });
            ...
            im2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/aIXBOVCnRs0?si=Uqj6D7z57H29JR49");
                }
            });
            ...
            im3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/lU7V6BxgiJE?si=gMGOZumZwGvTRIX9");
                }
            });
            ...
            im4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/_tDpMDN3Rdc?si=c88dZVlhlqb4vhde");
                }
            });
            ...
            im5.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/5uhCzmdncaE?si=bboX4E7Mdm-12fsz");
                }
            });
            ...
            im6.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/rdgKpCr8Id4?si=k03MllVLnvz6rtA3");
                }
            });
            im7.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/rvDsgZK83yQ?si=3UxQYFx7fApe13u1");
                }
            });
            im8.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    openUrl("https://youtu.be/KxuOTYCbu0U?si=Imw5ucZV-TEDfl_V");
                }
            });
        }
        ...
        private void toggleLike(int imageIndex) {
            ...
            switch (imageIndex) {
                case 1:
                    isLiked1 = !isLiked1;
                    editor.putBoolean("isLiked9", isLiked1);
                    like1.setImageResource(isLiked1 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 2:
                    isLiked2 = !isLiked2;
                    editor.putBoolean("isLiked10", isLiked2);
                    like2.setImageResource(isLiked2 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 3:
                    isLiked3 = !isLiked3;
                    editor.putBoolean("isLiked11", isLiked3);
                    like3.setImageResource(isLiked3 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 4:
                    isLiked4 = !isLiked4;
                    editor.putBoolean("isLiked12", isLiked4);
                    like4.setImageResource(isLiked4 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 5:
                    isLiked5 = !isLiked5;
                    editor.putBoolean("isLiked13", isLiked5);
                    like5.setImageResource(isLiked5 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 6:
                    isLiked6 = !isLiked6;
                    editor.putBoolean("isLiked14", isLiked6);
                    like6.setImageResource(isLiked6 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 7:
                    isLiked7 = !isLiked7;
                    editor.putBoolean("isLiked15", isLiked7);
                    like7.setImageResource(isLiked7 ? R.drawable.like2 : R.drawable.like1);
                ...
                case 8:
                    isLiked8 = !isLiked8;
                    editor.putBoolean("isLiked16", isLiked8);
                    like8.setImageResource(isLiked8 ? R.drawable.like2 : R.drawable.like1);
